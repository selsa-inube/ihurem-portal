...
const getEnumeratorsIhurem = async (
  ...
  for (let attempt = 1; attempt <= maxRetries; attempt++) {
    try {
      ...
      const res = await fetch(
        `${environment.IVITE_IPORTAL_EMPLOYEE_QUERY_PROCESS_SERVICE}/enumerators/${enumeratorName}?${queryParameters}`,
        {
          method: "GET",
          headers: {
            "X-Action": "GetEnum",
